...
return {
  ...
  keys = {
    { "<C-e>", desc = "Send paragraph to TidalCycles", mode = { "n", "v" }, ft = "tidal" },
    { "<localleader>ss", desc = "Send inner paragraph to TidalCycles", mode = "n", ft = "tidal" },
    { "<localleader>s", desc = "Send line/selection to TidalCycles", mode = { "n", "v" }, ft = "tidal" },
    { "<localleader>h", desc = "Silence all TidalCycles streams", mode = "n", ft = "tidal" },
  },
  init = function()
